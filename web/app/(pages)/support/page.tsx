...
export default function SupportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Create mailto link
    const mailtoLink = `mailto:leaflearning@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(
    ...
    setSuccess('Opening your email client... If it doesn\'t open automatically, please email us at leaflearning@gmail.com');
  ...
  const supportEmail = 'leaflearning@gmail.com';
