    ...
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-30 w-[calc(100%-2rem)] max-w-6xl rounded-2xl border border-white/20 bg-white/70 backdrop-blur-xl shadow-lg shadow-black/5">
      <div className="mx-auto flex h-14 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <a href="/signin" className="hidden sm:block rounded-xl px-4 py-2 text-sm text-gray-700 hover:bg-white/50 transition-colors">Log in</a>
          <a
            href="/signup"
            className="rounded-xl bg-emerald-600 px-3 py-2 md:px-4 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 transition-colors"
          >
            Get Started
          </a>
          {/* Mobile menu button */}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white/95 backdrop-blur-xl rounded-b-2xl">
          <nav className="flex flex-col p-4 space-y-3">
            <a href="#features" onClick={(e) => handleSmoothScroll(e, "features")} className="text-gray-600 hover:text-gray-900 py-2 px-3 rounded-lg hover:bg-gray-50">Features</a>
            <a href="#pricing" onClick={(e) => handleSmoothScroll(e, "pricing")} className="text-gray-600 hover:text-gray-900 py-2 px-3 rounded-lg hover:bg-gray-50">Pricing</a>
            <a href="#faq" onClick={(e) => handleSmoothScroll(e, "faq")} className="text-gray-600 hover:text-gray-900 py-2 px-3 rounded-lg hover:bg-gray-50">FAQ</a>
            <a href="/signin" className="text-gray-600 hover:text-gray-900 py-2 px-3 rounded-lg hover:bg-gray-50">Log in</a>
          </nav>
        </div>
      )}
    </header>
    ...
    <section className="relative w-full pt-32 pb-24 overflow-visible">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <motion.h1
          ...
          className="mt-8 text-3xl font-bold leading-tight text-gray-900 sm:text-4xl md:text-6xl lg:text-7xl px-4"
        >
        ...
        <motion.p
          ...
          className="mt-6 text-sm text-gray-500 sm:text-base md:text-lg max-w-2xl mx-auto px-4"
        >
...
function FeatureGrid() {
  return (
    <section id="features" className="mx-auto max-w-7xl px-6 py-24">
      ...
      <h2 className="text-center text-3xl font-bold sm:text-4xl md:text-5xl lg:text-6xl max-w-5xl mx-auto leading-tight text-gray-900 mb-6 px-4">
